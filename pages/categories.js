        ...
        <div className="col-md-6 mx-auto my-3">
            ...
            <div className="input-group mb-3">
                <input type="text" className="form-control"
                    placeholder="Tambahkan Menu Kategori" value={name}
                    onChange={e => setName(e.target.value)} />

                <button className="btn btn-success ml-1"
                    onClick={createCategory}>
                    {id ? <span className="text-uppercase"><i className="fas fa-pen-to-square mr-2"></i>Perbaruhi</span> : <span className="text-uppercase"><i className="fas fa-square-plus mr-2"></i>Tambah</span>}
                </button>
            </div>
